...
@Controller('uw')
export class UwUsecasesController {
  ...
  @Get('renewal/kpis')
  async renewalKpis(@Query('from') from?: string, @Query('to') to?: string) {
  ...
  @Get('renewal/by-lob')
  async renewalByLob(@Query('from') from?: string, @Query('to') to?: string) {
    const f1 = this.db.bmFilter(from, to, 'bm', 1);
    const f2 = this.db.bmFilter(from, to, 'bm', f1.nextIdx);
    const sql = `
      WITH prem AS (
  ...
  @Get('renewal/monthly')
  async renewalMonthly(@Query('from') from?: string, @Query('to') to?: string) {
  ...
  async profitabilityKpis(@Query('from') from?: string, @Query('to') to?: string) {
    const f1 = this.db.bmFilter(from, to, 'bm', 1);
    const f2 = this.db.bmFilter(from, to, 'bm', f1.nextIdx);
    const sql = `
      WITH prem AS (
  ...
  @Get('profitability/by-lob')
  async profitabilityByLob(@Query('from') from?: string, @Query('to') to?: string) {
    const f1 = this.db.bmFilter(from, to, 'bm', 1);
    const f2 = this.db.bmFilter(from, to, 'bm', f1.nextIdx);
    const sql = `
      WITH prem AS (
  ...
  async profitabilityMonthly(@Query('from') from?: string, @Query('to') to?: string) {
    const f1 = this.db.bmFilter(from, to, 'bm', 1);
    const f2 = this.db.bmFilter(from, to, 'bm', f1.nextIdx);
    const sql = `
      WITH prem AS (
  ...
  @Get('cancellation/kpis')
  async cancellationKpis(@Query('from') from?: string, @Query('to') to?: string) {
    const f = this.db.bmFilter(from, to);
    const sql = `
      SELECT
  ...
  @Get('cancellation/by-lob')
  async cancellationByLob(@Query('from') from?: string, @Query('to') to?: string) {
    const f = this.db.bmFilter(from, to);
    const sql = `
      SELECT
        COALESCE(lob.line_of_business_description,'Unknown') AS lob,
  ...
  @Get('cancellation/by-region')
  async cancellationByRegion(@Query('from') from?: string, @Query('to') to?: string) {
    const f = this.db.bmFilter(from, to);
    const sql = `
      SELECT
  ...
  @Get('cancellation/monthly')
  async cancellationMonthly(@Query('from') from?: string, @Query('to') to?: string) {
    const f = this.db.bmFilter(from, to);
    const sql = `
      SELECT
        bm.book_year||'-'||LPAD(bm.book_month::text,2,'0') AS month,
  ...
  @Get('cancellation/by-agent')
  async cancellationByAgent(@Query('from') from?: string, @Query('to') to?: string) {
    const f = this.db.bmFilter(from, to);
    const sql = `
      SELECT
  ...
  @Get('leakage/kpis')
  async leakageKpis(@Query('from') from?: string, @Query('to') to?: string) {
    const f = this.db.bmFilter(from, to);
    const sql = `
      SELECT
  ...
  @Get('leakage/by-lob')
  async leakageByLob(@Query('from') from?: string, @Query('to') to?: string) {
    const f = this.db.bmFilter(from, to);
    const sql = `
      SELECT
        COALESCE(lob.line_of_business_description,'Unknown') AS lob,
  ...
  @Get('leakage/by-product')
  async leakageByProduct(@Query('from') from?: string, @Query('to') to?: string) {
    const f = this.db.bmFilter(from, to);
    const sql = `
      SELECT
  ...
  @Get('leakage/monthly')
  async leakageMonthly(@Query('from') from?: string, @Query('to') to?: string) {
    const f = this.db.bmFilter(from, to);
    const sql = `
      SELECT
        bm.book_year||'-'||LPAD(bm.book_month::text,2,'0') AS month,
  ...
  @Get('leakage/by-underwriter')
  async leakageByUnderwriter(@Query('from') from?: string, @Query('to') to?: string) {
    const f = this.db.bmFilter(from, to);
    const sql = `
      SELECT
