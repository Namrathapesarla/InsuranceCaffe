...
export default function ClaimTAT() {
  ...
  const formatTat = (value) => {
    ...
    return num % 1 === 0 ? num.toLocaleString(locale) : num.toLocaleString(locale, { maximumFractionDigits: 2 });
  };
  ...
  return(<div>
    ...
    <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))',gap:'1rem',marginBottom:'1.5rem'}}>
      ...
      <StatCard icon={Timer} label="Avg TAT" value={formatTat(kpis.avg_tat_days)} suffix=" days" color="#8b5cf6"/>
      <StatCard icon={Timer} label="Max TAT" value={formatTat(kpis.max_tat_days)} suffix=" days" color="#f59e0b"/>
